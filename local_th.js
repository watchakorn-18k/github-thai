...
I18N.th["pubilc"] = { // 公共区域翻译
    ...
    "selector": [ // 元素筛选器规则
        ["a[aria-label='Pull requests you created']", "ดึงคำขอ"], // 顶部条 拉取请求
    ],
};
...
I18N.th["repository/settings/actions"] = { // 仓库设置 - 操作 /<user-name>/<repo-name>/settings/actions
    "static": { // 静态翻译
        ...
        "GitHub Terms of Service": "เงื่อนไขการให้บริการ GitHub",
